  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col overflow-hidden px-4 pt-4 pb-4">
        ...
        >
          <p className="text-[9px] text-gray-500 uppercase tracking-widest mb-2">When to {tab.label === "Surr." ? "surrender" : tab.label.toLowerCase()}</p>
        ...
        <div
          className="rounded-xl px-3 py-2.5 mb-3"
          style={{ background: "rgba(0,0,0,0.2)", border: `1px solid ${tab.border}` }}
        >
